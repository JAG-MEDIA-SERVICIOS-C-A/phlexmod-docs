...
# [ARCHIVO HISTÓRICO] Plan de Migración Teatro Ribas - Arquitectura MIA

> **Nota:** Este documento es un registro histórico del plan de migración ejecutado en Julio 2025. Se conserva para referencia. La arquitectura actual ya refleja estos cambios (ver `docs/architecture/modules-structure.md`).
