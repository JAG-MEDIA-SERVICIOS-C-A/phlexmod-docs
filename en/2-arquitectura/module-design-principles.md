...
### 5. Scaffolding y Generación de Código

Utiliza la CLI de Phlexmod para generar la estructura inicial de tus módulos. Esto asegura que se sigan las convenciones de nomenclatura y estructura desde el principio.

- [Creación de Módulos con la CLI](../6-guias/desarrollo/scaffolding-modulos.md)
