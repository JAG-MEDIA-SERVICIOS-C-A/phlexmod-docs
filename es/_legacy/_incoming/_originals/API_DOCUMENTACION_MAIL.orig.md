...
**Base URL**: `/backend/modules/settings/endpoints/mail_api/`
...
Este módulo sigue la estructura modular definida en `ESTRUCTURA_MODULAR.md` y se ubica específicamente en:

```
/backend/modules/settings/      # Módulos del sistema de administración
  ├── endpoints/mail_api/      # Endpoints API del módulo de correo
  ├── ui/mail_ui/             # Interfaces de usuario del módulo de correo
  ├── js/email.js             # Lógica JavaScript del módulo
  └── email.php               # Controlador principal del módulo
```
