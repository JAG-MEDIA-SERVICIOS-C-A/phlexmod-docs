...
> **Nota:** PHLEXMOD es **Air-Gapped Ready**. NO necesitas ejecutar `composer install` ni `npm install`. Todas las dependencias necesarias están incluidas en el repositorio para garantizar la Soberanía Tecnológica.
